...
export class HomePage {
  ...
  setfeed(type: string){
	...
	else if(this.feed =="friends")
		(<HTMLInputElement>document.getElementById('htextbox')).placeholder = "Say something to your Favorites...";
	else
		(<HTMLInputElement>document.getElementById('htextbox')).placeholder = "Say something to your Family...";
  }
